...
public class OcrUtil {
    static String host = "https://cardnumber.market.alicloudapi.com";
    static String path = "/rest/160601/ocr/ocr_idcard.json";
    static String appcode = "21fee1992bcb4943bf9df67e7a23fd0b";
    static String method = "POST";

    public static JSONObject idcardOcr(String imgFile, String side) throws Exception {
        ...
        configObj.put("quality_info", true);
